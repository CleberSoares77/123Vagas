    ...
    <div class="form-box">
        ...
        <?php endif; ?>
            ...
            <div class="mb-3 col-6">
                ...
                <input type="text" id="nome" name="nome" class="form-control" value="<?= isset($usuario) ? $usuario["nome"] : "" ?>">
            </div>

            <div class="mb-3 col-6">
                <label for="sobrenome" class="highlight-label">Sobrenome:</label>
                <input type="text" id="sobrenome" name="sobrenome" class="form-control" value="<?= isset($usuario) ? $usuario["sobrenome"] : "" ?>">
            </div>

            <div class="mb-3 col-6">
                <label for="contato" class="highlight-label">Contato:</label>
                <input type="number" id="contato" name="contato" class="form-control" value="<?= isset($usuario) ? $usuario["contato"] : "" ?>">
            </div>

            <div class="mb-3 col-6">
                <label for="email" class="highlight-label">Email:</label>
                <input type="email" id="email" name="email" class="form-control" value="<?= isset($usuario) ? $usuario["email"] : "" ?>">
            </div>

            <div class="mb-3 col-6">
                <label for="dataNasc" class="highlight-label">Data de Nascimento:</label>
                <input type="date" id="dataNasc" name="dataNasc" class="form-control" value="<?= isset($usuario) ? $usuario["dataNasc"] : "" ?>">
            </div>
            ...
            <div class="mb-3 col-6 position-relative">
                ...
                <div class="input-group">
                    <input type="password" id="senha" name="senha" class="form-control" value="<?= isset($usuario) ? $usuario["senha"] : "" ?>">
